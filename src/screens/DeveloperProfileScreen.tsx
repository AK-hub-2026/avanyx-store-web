...
export const DeveloperProfileScreen: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 px-4 sm:px-6 lg:px-8 pt-2 space-y-6">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-white dark:bg-[#1E1F23] border border-black/5 dark:border-white/5 shadow-sm">
        {/* Banner Graphic */}
        ...
        {/* Developer Info Area */}
        <div className="relative px-6 sm:px-8 pb-6 -mt-16 sm:-mt-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
